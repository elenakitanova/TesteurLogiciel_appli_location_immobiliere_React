...
export default function Banner({
  ...
  overlay = true,                 // overlay activé (à true) par défaut pour la Home
  ...
  return (
    ...
    <div className="banner" style={height ? { height } : undefined}>
      ...
      {/* Rendu conditionnel de l'overlay : Voile sombre (optionnel) */}
      {overlay && <div className="banner-overlay"/>}

      {/* Rendu conditionnel du titre : Titre centré (optionnel) : affiché uniquement si "title" est fourni */}
